...
app.post("/multiply",(req,res)=>{
    ...
    //const re=req.body.params.num1;
    let status;
    if(typeof num1==="string"||typeof num2==="string"||num1<-1000000||num2<-1000000||num1>1000000||num2>1000000||parseFloat(num1*num2)>1000000||parseFloat( num1*num2)<-1000000){
        status="error";
    }else{
        status="success";
    }
